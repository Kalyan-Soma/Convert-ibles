...
function LengthConverter() {
  ...
  useEffect(() => {
    const performConversion = async () => {
      try {
        const response = await axios.get(`${apiUrl}/convert/length`, {
          params: {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <div className="flex space-x-4">
              <div>
                ...
                >
                  ...
                  />
                  <span className="font-bold">Length Converter</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="flex items-center justify-center flex-grow px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-300 via-red-400 to-orange-300">
      ...
      <footer className="bottom-0 w-full p-4 text-white bg-gray-800">
        <div className="grid max-w-6xl grid-cols-1 gap-4 mx-auto md:grid-cols-4">
          <div>
            <h3 className="mb-2 text-lg font-bold">Length Converter</h3>
            <p>
              Easily switch between different length units for projects,
